...
public class Drone {
    ...
    public Drone (Camera camera) {
        mCamera=camera;
        /**Print a video text that shows the string "Loading new camera in progress!"
         * 
         */
        System.out.println("Loading new camera in progress! ");
              
    }
    /**Overloading of the costructor of the class Drone created for the case in which there is no camera inserted
     * 
     */
        public Drone () {
